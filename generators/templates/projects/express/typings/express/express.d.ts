...
declare module "express" {
    ...
    module e {
        ...
        interface IRouter<T> extends RequestHandler {
            ...
            // The definition of use has been modified from the original express.d.ts to avoid an incorrect warnig
            // use(...handler: RequestHandler[]): T;
            // use(handler: ErrorRequestHandler): T;
            use(handler: ErrorRequestHandler|RequestHandler, ...more: RequestHandler[]): T;
